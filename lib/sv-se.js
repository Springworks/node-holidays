...
Holiday.prototype.getHolidays = function(year) {
  ...
  output.push(getEasterSunday(year).subtract(2, 'days').format('YYYY-MM-DD'));
  output.push(getEasterSunday(year).format('YYYY-MM-DD'));
  output.push(getEasterSunday(year).add(1, 'days').format('YYYY-MM-DD'));
  output.push(getEasterSunday(year).add(4, 'days').add((7 * 5), 'days').format('YYYY-MM-DD'));
  output.push(getEasterSunday(year).add((7 * 7), 'days').format('YYYY-MM-DD'));
  output.push(getMidsummerDay(year).format('YYYY-MM-DD'));
  output.push(getAllSaintsDay(year).format('YYYY-MM-DD'));
